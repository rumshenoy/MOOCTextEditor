				...
				numToCheck += increment)
		{
			...
			*/
			...
			for(int i =0; i<trials; i++){
				BasicDocument basicDocument = new BasicDocument(stringFromFile);
			...
			for(int i =0; i<trials; i++){
				EfficientDocument efficientDocument = new EfficientDocument(stringFromFile);
